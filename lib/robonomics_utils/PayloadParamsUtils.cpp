...
uint64_t getNonce(BlockchainUtils *blockchainUtils) {
    blockchainUtils->setOnTextCallback(getNonceCallback);
    sendGetAccountNonceMessage(blockchainUtils);
    while (!got_nonce) {
...
void sendGetAccountNonceMessage(BlockchainUtils *blockchainUtils) {
